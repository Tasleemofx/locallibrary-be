...
async function authorCreate(index, firstName, family_name, d_birth, d_death) {
    const authordetail = { firstName: firstName, lastName: family_name };
    ...
    console.log(`Added author: ${firstName} ${family_name}`);
}
